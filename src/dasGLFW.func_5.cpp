...
void Module_dasGLFW::initFunctions_5() {
	...
	addExtern<void (*)(double),glfwSetTime>(*this,lib,"glfwSetTime",SideEffects::worstDefault,"glfwSetTime")
		->args({"time"});
	addExtern<unsigned long long (*)(),glfwGetTimerValue>(*this,lib,"glfwGetTimerValue",SideEffects::worstDefault,"glfwGetTimerValue");
	addExtern<unsigned long long (*)(),glfwGetTimerFrequency>(*this,lib,"glfwGetTimerFrequency",SideEffects::worstDefault,"glfwGetTimerFrequency");
